...
try {
  ...
  $personal = $pdo->prepare($sql);
  $personal->bindValue(":mem_no", $_SESSION["mem_no"]);
  $personal->execute();
  $personalRow = $personal->fetch(PDO::FETCH_ASSOC);
          ...
          <ul class="nav-item-icom">
            ...
            <li class="member-icon">
              <div id="membe-centre-img-circle">
                <img id="membe-centre-use-img" class="membe-centre-img" src="<?php echo $personalRow["mem_pic"] ?>" alt="會員" />
              </div>
  ...
  <div class="icon-mp">
    <div class="icon-login-box-mp">
      <div id="icon-login-box-mp-img">
        <img id="icon-login-box-mp-user-img" src="<?php echo $personalRow["mem_pic"] ?>" alt="會員" />
      </div>
  ...
  <div id="register-account" class="register-account">
    ...
    <div class="register-account-group">
      <div class="register-account-input-group">
        <span>姓名：</span>
        <input maxlength="10" type="text" name="register-account-memName" id="register-account-mem-name" placeholder="請輸入1至10字元" />
      </div>
      <div class="register-account-input-group">
        <span>帳號：</span>
        <input maxlength="10" type="text" name="register-account-mem-id" id="register-account-mem-id" placeholder="請輸入3至10字元" />
      </div>
      <div class="register-account-input-group">
        <span>密碼：</span>
        <input maxlength="10" type="password" name="register-account-mem-psw" id="register-account-mem-psw" placeholder="必須含有一個英文字母" />
      </div>
      <div class="register-account-input-group">
        <span>確認密碼：</span>
        <input maxlength="10" type="password" name="register-account-confirm-mem-psw" id="register-account-confirm-mem-psw" placeholder="請您再次輸入密碼" />
      </div>
      <div class="register-account-input-group">
        <span>信箱：</span>
        <input maxlength="30" type="email" name="register-account-emailaddress" id="register-account-email-address" placeholder="信箱必須包括(@和.)" />
      </div>
    </div>
